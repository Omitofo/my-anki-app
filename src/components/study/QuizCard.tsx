...
// ─────────────────────────────────────────────────────────────
// Full-screen canvas confetti (portal → body)
// ─────────────────────────────────────────────────────────────
const COLORS = [
...
function FullScreenConfetti({ onDone }: { onDone: () => void }) {
  ...
  useEffect(() => {
    ...
    // 120 particles launched from centre-top area
...
export function QuizCard({
  ...
  // ── richer correct / wrong colours ────────────────────────
  const optionCls: Record<string, string> = {
    idle:
      'border-mist/20 bg-paper-card hover:border-accent/40 hover:bg-paper-warm text-ink cursor-pointer',
    correct:
      'border-emerald-400 bg-emerald-50 text-emerald-800 shadow-[0_0_0_3px_rgba(52,211,153,0.25)]',
    wrong:
      'border-red-400 bg-red-50 text-red-700 shadow-[0_0_0_3px_rgba(248,113,113,0.25)]',
    dim:
      'border-mist/10 bg-paper/60 text-mist/40 cursor-default',
  }
          ...
          <button
            ...
            className={cn(
              ...
              canGoPrev && !isTransitioning
                ...
                : 'border-mist/10 text-mist/30 cursor-not-allowed'
            )}
          >
            ← Prev
          </button>
          ...
          <button
            ...
            className={cn(
              ...
              !isTransitioning
                ...
                : 'bg-ink/40 text-paper/40 cursor-not-allowed'
            )}
          >
            Next →
          </button>
