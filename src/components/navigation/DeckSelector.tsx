    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {decks.map((deck: Deck, i: number) => (
        <button
          ...
          className="group bg-paper-card rounded-2xl p-6 text-left border border-mist/10 hover:border-accent/30 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 animate-slide-up"
        ...
        >
          ...
          <h3 className="font-display text-base text-ink mb-2 group-hover:text-accent transition-colors duration-200">
            {deck.name}
          </h3>
          {deck.description && (
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <span className="text-accent/40 group-hover:text-accent transition-colors duration-200">
              →
            </span>
          </div>
        </button>
